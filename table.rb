...
tables = [
	...
	"lecturer " +
		"department_id:integer first_name:string last_name:string email:string cell_phone:string work_phone:string status:boolean photo:string",
	...
	"people " +
		"department_id:integer first_name:string last_name:string password:string status:integer photo:string"
]
